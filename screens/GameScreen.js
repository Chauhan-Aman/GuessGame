...
function GameScreen({ userNumber, onGameOver }) {
    ...
    function nextGuessHandler(direction) {  // direction => 'lower' , 'greater'
        ...
        setGuessRounds(prevGuessRounds => [newRndNumber, ...prevGuessRounds]);  // Add newRndNumber in array of setGuessRounds at first index (if we use [...prevGuessRounds, newRndNumber] then it add newRndNumber in array of setGuessRounds at last index)
    }
